    ...
    >
      ...
      >
        <div
          style={{
            position: "absolute",
            inset: 0,
            filter: "grayscale(0.85) brightness(.85) contrast(1.05)",
          }}
        >
          <Starfield
            nebula="radial-gradient(900px 700px at 40% 40%,#131416 0%,#0a0b0c 55%,#050506 100%)"
            twinkleOpacity={0.4}
          />
        </div>
      ...
      <div
        style={{
          ...
          padding: 40,
          background: "radial-gradient(600px 500px at 70% 0%,#0c0d0f,#050506)",
        }}
      >
        <div style={{ width: "100%", maxWidth: 400 }}>
          ...
          >
            <span
              style={{ width: 8, height: 8, border: `1px solid ${steel}` }}
            />
            <span
              style={{
                fontFamily: "'Chakra Petch',sans-serif",
          ...
          {errorMsg && (
            <div
              style={{
                ...
                marginBottom: 16,
                border: `1px solid ${
                  errorMsg.includes("成功") ? steel : "#b08585"
                }`,
                color: errorMsg.includes("成功") ? steel : "#b08585",
                fontSize: 13,
                borderRadius: 2,
              }}
            >
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              placeholder="explorer@stellar.io"
              style={inputStyle}
            />
          </div>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <button
                ...
                style={isCreator ? roleIdle : roleActive}
              >
                <span
                  style={{
                    fontFamily: "'Chakra Petch',sans-serif",
              ...
              <button
                ...
                style={isCreator ? roleActive : roleIdle}
              >
                <span
                  style={{
                    fontFamily: "'Chakra Petch',sans-serif",
