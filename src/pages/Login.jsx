    ...
    <div style={{ display: "flex", width: "100%", minHeight: "100vh", background: "#07080a", fontFamily: "'Noto Sans TC',sans-serif" }}>
      ...
      <div style={{ flex: 1, minWidth: 0, display: "flex", alignItems: "center", justifyContent: "center", padding: 40, background: "radial-gradient(600px 500px at 70% 0%,#0c0d0f,#050506)" }}>
        <div style={{ width: "100%", maxWidth: 400 }}>
          ...
          <button onClick={submit} style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", height: 50, background: "rgba(255,255,255,.06)", color: ink, fontFamily: "'Space Mono',monospace", fontWeight: 400, fontSize: 13, border: `1px solid ${lineStrong}`, borderRadius: 2, letterSpacing: ".16em", textTransform: "uppercase", cursor: "pointer" }}>登入艦橋 ▸</button>
